...
| `--forward` | `host:guest` TCP ports | none | With user-mode NAT, publishes a guest TCP port on every host interface. Repeatable and deliberately LAN-visible. | `scripts/run-qemu.sh --network-nat --forward 8080:80` |

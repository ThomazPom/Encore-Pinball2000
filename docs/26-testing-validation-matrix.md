...
The `--all-updates` sweep recorded on 2026-07-16 passed 45 of 45 rows:
...
> [!NOTE]
> This table records that run. Run the command above to produce a result for
> the current commit, installed updates and host.

...
"                             Direct ioperm()+inb/outb, mirrors what nucore\n"
"                             does. Lower per-access latency, sub-µs strobe\n"
"                             pacing via outb(0x80). Requires CAP_SYS_RAWIO\n"
"                             (run as root, or one-time:\n"
